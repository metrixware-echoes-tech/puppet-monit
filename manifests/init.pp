class monit (
  ...
  $httpd_htpasswd_file       = $monit::params::httpd_htpasswd_file,
  $httpd_htpasswd_crypto     = $monit::params::httpd_htpasswd_crypto,
  $httpd_htpasswd_users      = $monit::params::httpd_htpasswd_users,
  ...
  validate_string($httpd_htpasswd_file)
  validate_string($httpd_htpasswd_crypto)
  validate_array($httpd_htpasswd_users)
